...
class Rectangle(Base):
    ...
    @property
    def x(self):
        """to get/set the x coordinate of the Rectangle."""
        return self.__x
    ...
    @property
    def y(self):
        """to get/set the y coordinate of the Rectangle."""
        return self.__y
    ...
    def display(self):
        """to print the Rectangle using the `#` character."""
    ...
    def __str__(self):
        """to return the print() and str() representation of the Rectangle."""
