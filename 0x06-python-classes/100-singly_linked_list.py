#!/usr/bin/python3
"""This will define classes for a singly-linked list."""
...
class Node:
    ...
    def __init__(self, data, next_node=None):
        """This is to initialize a new Node.
        Args:
    ...
    @property
    def next_node(self):
        """To set the next_node of the Node."""
...
class SinglyLinkedList:
    """This is representing a singly-linked list."""
