-- This only lists all shows contained in hbtn_0d_tvshows that have at least one genre linked
-- This only lists all rows of a database that have one column in common
